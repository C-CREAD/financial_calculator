...
The user will have the option of selecting either an investment or a bond, where the program will request the user for certain inputs to return the corresponding results.
